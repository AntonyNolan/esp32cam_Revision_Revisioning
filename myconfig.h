/* 
 * Antony Nolan - AI Thinker w Facial Recognition and Detection
 * 
...
#define CAM_NAME "Antony Door ESP32 camsvr"
...
// Credentials
const char* ssid = "PonzNet";
const char* password = "gr3yskull";
